            ...
            <>
                ...
                <form className="container bg-dark pt-2" style={{ width: "30vw" }}>
                    <div className="form-group">
                        <input type="email" id="email1" className="form-control text-center mt-3" placeholder="Enter Registered Email"  name="email1" value={this.state.email} onChange={this.onChange} onBlur={this.validateEmail} onFocus={this.removeAlert} required /><span id="emailVR" style={{ color: "red" }}></span>
                    </div>
